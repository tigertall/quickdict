...
从 [GitHub Releases](https://github.com/tigertall/quickdict/releases) 下载预构建包，无需本地编译。

### 主程序（Flatpak）

```bash
# 下载对应架构的 .flatpak 文件，然后安装
flatpak install --user quickdict-x86_64.flatpak
# ARM 设备用 quickdict-aarch64.flatpak
```

### GNOME Shell 扩展

```bash
gnome-extensions install --force quickdict-focus@tigertall.github.com.zip
```
